...
fitnessValues_1_1 = np.load("data/fitnessVals_1_0.1.npy")
fitnessValues_1_1 = np.load("data/fitnessVals_1_0.2.npy")
fitnessValues_1_1 = np.load("data/fitnessVals_2_0.1.npy")
fitnessValues_1_1 = np.load("data/fitnessVals_2_0.2.npy")
fitnessValues_1_1 = np.load("data/fitnessVals_3_0.1.npy")
fitnessValues_1_1 = np.load("data/fitnessVals_3_0.2.npy")
